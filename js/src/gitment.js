...
var Gitment = function () {
  ...
  function Gitment() {
    ...
    if (query.code) {
      ...
      var logging = !proxy_gateway ? _utils.http.post('https://fulln.me/cros', { code: code, client_id: client_id, client_secret: client_secret }, '') : _utils.http.post('/login/oauth/access_token', 'code=' + code + '&client_id=' + client_id, proxy_gateway);
